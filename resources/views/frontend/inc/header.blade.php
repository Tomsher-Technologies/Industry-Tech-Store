            ...
            <div class="ps-container align-items-center">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-6">
                                                <ul class="mega-menu__list">
                                                    ...
                                                    <li><a href="#.html">
                                                            <h4>Gas Detection Tubes<span class="sub-toggle"></span></h4>
                                                        </a></li>
                                                    <li><a href="#.html">
                ...
                <div class="header__right">
                    <div class="header__actions">
                        <a class="header__extra" href="compare.html">
                                ...
                                <div class="ps-cart__items">
                                    <div class="ps-product--cart-mobile">
                                        <div class="ps-product__thumbnail"><a href="#"><img
                                                    src="{{ frontendAsset('img/products/shop/01.jpg') }}"
                                                    alt="" /></a></div>
                                        <div class="ps-product__content"><a class="ps-product__remove"
                                                href="#"><i class="icon-cross"></i></a><a
                                                href="product-default.html">Tyco Alarm
                                                Bell with Base ADT – 576.501.022.T</a>
                                            <p><strong>Brand:</strong> Tyco </p><small>1 x AED59.99</small>
                                        </div>
                                    </div>
                                    <div class="ps-product--cart-mobile">
                                        <div class="ps-product__thumbnail"><a href="#"><img
                                                    src="{{ frontendAsset('img/products/shop/02.jpg') }}"
                                                    alt="" /></a></div>
                                        <div class="ps-product__content"><a class="ps-product__remove"
                                                href="#"><i class="icon-cross"></i></a><a
                                                href="product-default.html">BW Clip
                                                H2S 3 Years – BWC3H </a>
                                            <p><strong>Brand:</strong> BW </p><small>1 x AED59.99</small>
                                        </div>
                                    </div>
                                </div>
