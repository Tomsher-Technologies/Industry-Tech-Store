                            ...
                            <div class="mega-menu mega-menu-medium">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="mega-menu__list">
                                            <li><a href="#.html">
                                                    <h4>Fixed Gas Detection Systems<span class="sub-toggle"></span></h4>
                                                </a></li>
                                            <li><a href="#.html">
                            ...
                            <div class="mega-menu mega-menu-medium">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="mega-menu__list">
                                            <li><a href="#.html">
                                                    <h4> Addressable Control Panel<span class="sub-toggle"></span></h4>
                                                </a></li>
                                            <li><a href="#.html">
                                                    <h4>Audible and Visual Alarms<span class="sub-toggle"></span></h4>
                                                </a></li>
                                            <li><a href="#.html">
                                                    <h4>Base<span class="sub-toggle"></span></h4>
                                                </a></li>
                                            <li><a href="#.html">
                                                    <h4>Conventional Control Panel<span class="sub-toggle"></span></h4>
                                                </a></li>
                                            <li><a href="#.html">
                                            ...
                                            <li><a href="#.html">
                                                    <h4>Optical Smoke & Heat Detector <span class="sub-toggle"></span>
                                                    </h4>
                                                </a></li>
                                            <li><a href="#.html">
