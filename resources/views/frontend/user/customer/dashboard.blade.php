                ...
                @if(Auth::user()->addresses != null)
                    ...
                    @if($address != null)
                        <ul class="list-unstyled mb-0">
                            <li class=" py-2"><span>Address : {{ $address->address }}</span></li>
                            <li class=" py-2"><span>Country : {{ $address->country->name }}</span></li>
                            <li class=" py-2"><span>State : {{ $address->state->name }}</span></li>
                            <li class=" py-2"><span>City : {{ $address->city->name }}</span></li>
                            <li class=" py-2"><span>Postal Code : {{ $address->postal_code }}</span></li>
                            <li class=" py-2"><span>Phone : {{ $address->phone }}</span></li>
                        </ul>
                    @endif
                @endif
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                @if($customer_package != null)
                    ...
                    <p class="mb-1 text-muted">Product Upload: {{ $customer_package->product_upload }} {{ translate('Times')}}</p>
                    <p class="text-muted mb-4">Product Upload Remaining: {{ Auth::user()->remaining_uploads }} {{ translate('Times')}}</p>
