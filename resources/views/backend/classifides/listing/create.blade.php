        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">Classifide Information</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('classifides.store') }}" method="POST"
                        ...
                        @livewire('slug-check', ['model' => 'App\\Models\\Classifieds\\ClassifiedListing', 'template' => 2])
                        @error('slug')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
